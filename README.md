...
finishing all of my documentation. A final thing that I would like to
add is a function to simulate random variables from the asymptotic
distribution, but I will likely need to do some testing to decide if it
is more efficient to try and generate these by generating a uniform
random variable on (0, 1) and passing this as a function to some
